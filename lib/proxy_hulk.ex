defmodule ProxyHulk do
  ...
  def handle_info(:check_tick, state) do
    try do
      case Skn.Config.get(:proxy_hulk) do
        {username, _} ->
    ...
    reset_timer(:check_tick_ref, :check_tick, Skn.Config.get(:tm_proxy_hulk, 120_000))
    {:noreply, state}
  end
